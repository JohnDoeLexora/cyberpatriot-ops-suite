...
<#
.SYNOPSIS
  CyberPatriot defensive op: disable-legacy-r-services
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'disable-legacy-r-services' -Username $Username -Service $Service -Package $Package `
