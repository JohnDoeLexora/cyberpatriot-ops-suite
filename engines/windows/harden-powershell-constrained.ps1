...
<#
.SYNOPSIS
  CyberPatriot defensive op: harden-powershell-constrained
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'harden-powershell-constrained' -Username $Username -Service $Service -Package $Package `
