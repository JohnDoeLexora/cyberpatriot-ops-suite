...
<#
.SYNOPSIS
  CyberPatriot defensive op: disable-llmnr-netbios-wpad
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'disable-llmnr-netbios-wpad' -Username $Username -Service $Service -Package $Package `
