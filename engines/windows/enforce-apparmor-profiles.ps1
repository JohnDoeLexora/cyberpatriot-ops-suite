...
<#
.SYNOPSIS
  CyberPatriot defensive op: enforce-apparmor-profiles
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'enforce-apparmor-profiles' -Username $Username -Service $Service -Package $Package `
