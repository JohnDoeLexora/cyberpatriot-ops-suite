...
<#
.SYNOPSIS
  CyberPatriot defensive op: disable-remote-assistance
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'disable-remote-assistance' -Username $Username -Service $Service -Package $Package `
