...
<#
.SYNOPSIS
  CyberPatriot defensive op: report-password-never-expires
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'report-password-never-expires' -Username $Username -Service $Service -Package $Package `
