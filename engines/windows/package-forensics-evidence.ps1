...
<#
.SYNOPSIS
  CyberPatriot defensive op: package-forensics-evidence
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'package-forensics-evidence' -Username $Username -Service $Service -Package $Package `
