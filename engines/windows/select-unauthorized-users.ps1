...
<#
.SYNOPSIS
  CyberPatriot defensive op: select-unauthorized-users
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'select-unauthorized-users' -Username $Username -Service $Service -Package $Package `
