...
<#
.SYNOPSIS
  CyberPatriot defensive op: apply-default-deny-inbound
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'apply-default-deny-inbound' -Username $Username -Service $Service -Package $Package `
