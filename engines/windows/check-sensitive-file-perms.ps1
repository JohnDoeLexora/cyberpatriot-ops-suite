...
<#
.SYNOPSIS
  CyberPatriot defensive op: check-sensitive-file-perms
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'check-sensitive-file-perms' -Username $Username -Service $Service -Package $Package `
