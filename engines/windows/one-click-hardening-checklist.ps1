...
<#
.SYNOPSIS
  CyberPatriot defensive op: one-click-hardening-checklist
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'one-click-hardening-checklist' -Username $Username -Service $Service -Package $Package `
