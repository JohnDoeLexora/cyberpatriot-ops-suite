...
<#
.SYNOPSIS
  CyberPatriot defensive op: audit-ssh-authorized-keys
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'audit-ssh-authorized-keys' -Username $Username -Service $Service -Package $Package `
