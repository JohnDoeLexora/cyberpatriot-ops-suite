...
<#
.SYNOPSIS
  CyberPatriot defensive op: audit-critical-perm-drift
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'audit-critical-perm-drift' -Username $Username -Service $Service -Package $Package `
