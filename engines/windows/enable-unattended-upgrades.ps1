...
<#
.SYNOPSIS
  CyberPatriot defensive op: enable-unattended-upgrades
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'enable-unattended-upgrades' -Username $Username -Service $Service -Package $Package `
