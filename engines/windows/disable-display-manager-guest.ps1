...
<#
.SYNOPSIS
  CyberPatriot defensive op: disable-display-manager-guest
.DESCRIPTION
...
$result = Invoke-CpOp -OpId 'disable-display-manager-guest' -Username $Username -Service $Service -Package $Package `
