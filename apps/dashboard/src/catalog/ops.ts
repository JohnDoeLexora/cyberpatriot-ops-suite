...
const RUN_LABELS: Record<string, string> = {
  ...
  'select-unauthorized-users': 'Select extra accounts',
  'audit-sticky-tmp': 'Check sticky /tmp',
  'audit-anonymous-ftp': 'Check anonymous FTP',
  'harden-vsftpd': 'Harden vsftpd',
  'audit-web-server': 'Check Apache/nginx',
  'disable-llmnr-netbios-wpad': 'Turn off LLMNR/WPAD',
  'audit-null-session': 'Check null sessions',
  'audit-idle-lock': 'Check idle lock',
  'hunt-sysprep-leftovers': 'Hunt sysprep leftovers',
  'audit-snmp': 'Check SNMP',
  'audit-mac-enforcement': 'Check AppArmor/SELinux',
  'audit-browser-baseline': 'Check browser settings',
  'audit-auto-updates': 'Check auto-updates',
  ...
  'harden-print-spooler': 'Harden print spooler',
  'audit-lsa-protection': 'Check LSA protection',
  'audit-credential-guard': 'Check Credential Guard',
  'audit-secure-boot': 'Check Secure Boot',
  'audit-wifi-profiles': 'Check Wi-Fi profiles',
  'harden-powershell-constrained': 'Harden PowerShell logging',
  'disable-smb-client-v1': 'Turn off SMBv1 client',
  'audit-dns-client': 'Check DNS client',
  'audit-windows-roles': 'Check Windows roles',
  'harden-null-session': 'Harden null sessions',
  'blacklist-kernel-modules': 'Blacklist kernel modules',
  'enforce-apparmor-profiles': 'Enforce AppArmor',
  'enable-unattended-upgrades': 'Turn on auto-upgrades',
  'audit-mail-services': 'Check mail servers',
  'audit-database-bind': 'Check database bind',
  'audit-php-hardening': 'Check PHP settings',
  'audit-snap-flatpak': 'Check snap/flatpak',
  'disable-ctrl-alt-del': 'Turn off Ctrl+Alt+Del',
  'audit-ipv6-privacy': 'Check IPv6 privacy',
  'audit-log-persistence': 'Check log persistence',
  'audit-browser-policy': 'Check browser policy',
  'harden-usb-storage': 'Harden USB storage',
  'audit-time-timezone': 'Check time and timezone',
  'export-coach-packet': 'Export coach packet',
}
...
export const LEGACY_OP_IDS: Record<string, string> = {
  ...
  'linux.mac': 'audit-mac-enforcement',
